...
ui_intro <- column(width = 12,
  ...
  p(
    ...
    "according to a grand plan.  The borders reflect historical events,",
    "political bargains, and other considerations that are less relevant",
    "in modern times.  As a result, US states contain unequal numbers of people",
    "and unequal land areas. In addition, state borders cross through major",
  ...
  p(
    "Choose whether to implement each of the three changes and how",
    "they will be implemented.  Once you make the change, the maps will update",
    ...
    "equality between states, and a score of 100% indicates egregious",
  ...
  p(
    ...
    "contiguous, and metro areas are no longer split between different",
    "state jurisdictions.  In short, minor changes to the current state",
  ...
  p(
    ...
    "implement changes when you select new options.  The tool is finished",
